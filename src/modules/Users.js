...
export default function Users(root) {
    ...
    axios('http://192.168.0.102:3000/users', axiosConfig)
        .then(result => {
        ...
        function deleteUser(trUser) {
            ...
            if (id != undefined && !isNaN(id)) {
                axios.delete('http://192.168.0.102:3000/user/' + id, axiosConfig).then(response => {
        ...
        buttonSend.addEventListener('click', function (e) {
            ...
            if (name != undefined && year != undefined) {
                ...
                axios.post('http://192.168.0.102:3000/user/create', users, axiosConfig).then(response => {
                    if (response.status == 200) {
        ...
        buttonSendEdit.addEventListener('click', function (e) {
            ...
            axios.put('http://192.168.0.102:3000/user/' + id, users, axiosConfig).then(response => {
                if (response.status == 200) {
