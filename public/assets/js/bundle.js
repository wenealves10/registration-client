...
function Users(root) {
  ...
  axios('http://192.168.0.102:3000/users', axiosConfig).then(function (result) {
    if (result.status == 200) {
  ...
  function deleteUser(trUser) {
    ...
    if (id != undefined && !isNaN(id)) {
      axios["delete"]('http://192.168.0.102:3000/user/' + id, axiosConfig).then(function (response) {
  ...
  buttonSend.addEventListener('click', function (e) {
    ...
    if (name != undefined && year != undefined) {
      ...
      axios.post('http://192.168.0.102:3000/user/create', users, axiosConfig).then(function (response) {
        if (response.status == 200) {
  ...
  buttonSendEdit.addEventListener('click', function (e) {
    ...
    axios.put('http://192.168.0.102:3000/user/' + id, users, axiosConfig).then(function (response) {
      if (response.status == 200) {
