...
function Users(root) {
  ...
  axios('http://registration-api:3000/users', axiosConfig).then(function (result) {
    if (result.status == 200) {
  ...
  function deleteUser(trUser) {
    ...
    if (id != undefined && !isNaN(id)) {
      axios["delete"]('http://registration-api:3000/user/' + id, axiosConfig).then(function (response) {
  ...
  buttonSend.addEventListener('click', function (e) {
    ...
    if (name != undefined && year != undefined) {
      ...
      axios.post('http://registration-api:3000/user/create', users, axiosConfig).then(function (response) {
        if (response.status == 200) {
  ...
  buttonSendEdit.addEventListener('click', function (e) {
    ...
    axios.put('http://registration-api:3000/user/' + id, users, axiosConfig).then(function (response) {
      if (response.status == 200) {
